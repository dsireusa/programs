 ...
 *
 */
angular.module('ncsolar').factory('alertFactory', function($timeout, $filter) {
...
angular.module('ncsolar').service('alert', function(alertFactory) {
    var alerts = new alertFactory();
    return alerts;
});

angular.module('ncsolar').factory('formAlertFactory', function($timeout, $filter, alertFactory) {
...
angular.module('ncsolar').service('formAlert', function(formAlertFactory) {
