 ...
 */
class SearchLog extends \Application\Entity\Base\Program\SearchLog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'searchTS', 'userIP', 'filterType', 'text', 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SearchLog $proxy) {
    ...
    public function setText($filterText)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setText', array($filterText));

        return parent::setText($filterText);
    }
    ...
    public function getSearchTS()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSearchTS', array());

        return parent::getSearchTS();
    }
    ...
    public function setSearchTS($searchDate)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSearchTS', array($searchDate));

        return parent::setSearchTS($searchDate);
    }
