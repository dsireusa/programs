...
namespace DoctrineORMModule\Proxy\__CG__\Application\Entity\Base\Program\Detail;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Template extends \Application\Entity\Base\Program\Detail\Template implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'programType', 'label', 'displayOrder', 'id');
        }
    ...
    public function getProgramType()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProgramType', array());

        return parent::getProgramType();
    }

    /**
     * {@inheritDoc}
     */
    public function setProgramType(\Application\Entity\Base\Program\TypeInterface $programType)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProgramType', array($programType));

        return parent::setProgramType($programType);
    }
