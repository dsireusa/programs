 ...
 */
class Utility extends \Application\Entity\Base\Utility implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'utilityId', 'state', 'programs', 'zipCodes', 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Utility $proxy) {
    ...
    public function getEIAId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEIAId', array());

        return parent::getEIAId();
    }
    ...
    public function setEIAId($EIAId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEIAId', array($EIAId));

        return parent::setEIAId($EIAId);
    }
