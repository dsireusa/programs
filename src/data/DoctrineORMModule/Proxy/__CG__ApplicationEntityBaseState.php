 ...
 */
class State extends \Application\Entity\Base\State implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'abbreviation', 'territory', 'id');
        }
    ...
    public function isTerritory()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isTerritory', array());

        return parent::isTerritory();
    }
