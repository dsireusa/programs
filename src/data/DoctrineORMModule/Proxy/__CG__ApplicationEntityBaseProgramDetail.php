 ...
 */
class Detail extends \Application\Entity\Base\Program\Detail implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'program', 'label', 'value', 'displayOrder', 'template', 'id');
        }
     ...
     * {@inheritDoc}
     */
    public function setTemplate(\Application\Entity\Base\Program\Detail\TemplateInterface $template)
    {
