...
namespace DoctrineORMModule\Proxy\__CG__\Application\Entity\Base\Technology\Category;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class EnergyCategory extends \Application\Entity\Base\Technology\Category\EnergyCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'categories', 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EnergyCategory $proxy) {
     ...
     * {@inheritDoc}
     */
    public function hasCategory(\Application\Entity\Base\Technology\CategoryInterface $category)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasCategory', array($category));
     ...
     * {@inheritDoc}
     */
    public function addCategory(\Application\Entity\Base\Technology\CategoryInterface $category)
    {
     ...
     * {@inheritDoc}
     */
    public function removeCategory(\Application\Entity\Base\Technology\CategoryInterface $category)
    {
    ...
    public function countCategories()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'countCategories', array());
