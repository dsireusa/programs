 ...
 */
class Contact extends \Application\Entity\Base\Program\Contact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'program', 'contact', 'webVisible', 'id');
        }
    ...
    public function isWebVisible()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isWebVisible', array());

        return parent::isWebVisible();
    }
    ...
    public function setWebVisible($webVisible = true)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setWebVisible', array($webVisible));

        return parent::setWebVisible($webVisible);
    }
