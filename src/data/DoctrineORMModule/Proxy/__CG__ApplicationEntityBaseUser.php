...
class User extends \Application\Entity\Base\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'subscriptionMemos', 'programMemos', 'firstName', 'lastName', 'username', 'password', 'passwordToken', 'role', 'createdTs', 'updatedTs', 'email', 'state', 'id');
        }
