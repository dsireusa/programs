...
namespace DoctrineORMModule\Proxy\__CG__\Application\Entity\Base\Technology;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Category extends \Application\Entity\Base\Technology\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'energyCategory', 'technologies', 'id');
        }
    ...
    public function getEnergyCategory()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEnergyCategory', array());

        return parent::getEnergyCategory();
    }

    /**
     * {@inheritDoc}
     */
    public function setEnergyCategory(\Application\Entity\Base\Technology\Category\EnergyCategoryInterface $energyCategory)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEnergyCategory', array($energyCategory));

        return parent::setEnergyCategory($energyCategory);
    }
