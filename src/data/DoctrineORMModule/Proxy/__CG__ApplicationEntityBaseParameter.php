 ...
 */
class Parameter extends \Application\Entity\Base\Parameter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'source', 'qualifier', 'amount', 'units', 'parameterSet', 'id');
        }
    ...
    public function getParameterSet()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getParameterSet', array());

        return parent::getParameterSet();
    }

    /**
     * {@inheritDoc}
     */
    public function setParameterSet(\Application\Entity\Base\Parameter\SetInterface $parameterSet)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setParameterSet', array($parameterSet));

        return parent::setParameterSet($parameterSet);
    }
