 ...
 */
class Technology extends \Application\Entity\Base\Technology implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'category', 'programs', 'active', 'id');
        }
     ...
     * {@inheritDoc}
     */
    public function setCategory(\Application\Entity\Base\Technology\CategoryInterface $category)
    {
