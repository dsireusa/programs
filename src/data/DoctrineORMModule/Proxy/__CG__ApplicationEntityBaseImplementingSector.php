 ...
 */
class ImplementingSector extends \Application\Entity\Base\ImplementingSector implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'programs', 'active', 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ImplementingSector $proxy) {
    ...
    public function clearPrograms()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'clearPrograms', array());

        return parent::clearPrograms();
    }
