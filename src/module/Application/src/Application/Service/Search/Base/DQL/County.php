...
class County extends DQL
{
    ...
    {
        return 'Application\Entity\Base\Program\County';
    }
    ...
    protected function addFilters(Params $params, QueryBuilder $qb)
    {
        ...
        return parent::addFilters($params, $qb)->filterHasName($params, $qb)->filterByState($params, $qb);
    }
