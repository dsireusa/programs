angular.module('ncsolar').controller('TablesCtrl', ["$scope", "Restangular", "select2Category", "select2Technology", "$timeout", "alert", function($scope, Restangular, select2Category, select2Technology, $timeout, alert) {
