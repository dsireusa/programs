angular.module('ncsolar').controller('CoverageCtrl', ["$scope", "select2Utility", "select2City", "select2County", "select2ZipCode", function($scope, select2Utility, select2City, select2County, select2ZipCode) {
