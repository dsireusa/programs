angular.module('ncsolar').controller('NewContactCtrl', ["$scope", "$rootScope", "Restangular", "editService", "select2State", function($scope, $rootScope, Restangular, editService, select2State) {
