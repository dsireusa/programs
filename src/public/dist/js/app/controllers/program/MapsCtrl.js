angular.module('ncsolar').controller('MapsCtrl', ["$scope", "Restangular", "select2Type", "select2Technology", "alert", function($scope, Restangular, select2Type, select2Technology, alert) {
