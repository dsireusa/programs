angular.module('ncsolar').controller('EditCtrl', ["$scope", "$rootScope", "Restangular", "editService", "select2State", "select2Contact", "$timeout", "debounce", "alert", function($scope, $rootScope, Restangular, editService, select2State, select2Contact, $timeout, debounce, alert) {
