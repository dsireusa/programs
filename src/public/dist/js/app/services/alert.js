 ...
 *
 */
angular.module('ncsolar').factory('alertFactory', ["$timeout", "$filter", function($timeout, $filter) {
...
angular.module('ncsolar').service('alert', ["alertFactory", function(alertFactory) {
    var alerts = new alertFactory();
    return alerts;
}]);

angular.module('ncsolar').factory('formAlertFactory', ["$timeout", "$filter", "alertFactory", function($timeout, $filter, alertFactory) {
...
angular.module('ncsolar').service('formAlert', ["formAlertFactory", function(formAlertFactory) {
