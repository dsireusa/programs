angular.module('ncsolar').service('editService', ["Restangular", "alert", "formAlert", "$window", "$log", function(Restangular, alert, formAlert, $window, $log) {
    return {
        init: function($scope) {
            var options = $.extend({
            ...
            $scope.save = function(entity) {
                ...
                options.fnUpdateR(entity).post(entity.id,entityData).then(function(data) {
                    // Handle Errors
                    ...
                    try {
                        if (result && result.data && result.data.messages && options.errorCallback) {
                            options.errorCallback(result.data);
                        } else if (options.failCallback) {
