angular.module('ncsolar').service('select2Technology', ["Restangular", "select2", function(Restangular, select2) {
    var resource = 'technologies';
